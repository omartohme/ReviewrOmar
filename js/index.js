...
//        document.querySelector(".back").setAttribute("data-href", "#readreview")
        document.querySelector("#newReview").setAttribute("data-href", "listreview");
        document.querySelector("#newReview").addEventListener("click", app.navigate);
        ...
        document.getElementById("camera").addEventListener("click", function () {
            ...
            function imgFail(message) {
                console.log("Woops! Looks like something went wrong xD," + message);
            }
        });
            ...
            for (var i = 0; i < response.reviews.length; i++) {
                ...
                li.addEventListener("click", function () {
                    ...
                    xhr.addEventListener("load", function (ev) {
                        ...
                        document.getElementById("newTitle").innerHTML = response.review_details.title;
                        document.getElementById("newReview").innerHTML = response.review_details.review_txt;
                        if (response.review_details.rating == 1) {
                                                                            
                                                
                            
                            // get another id - and do this logic
                            var img = document.createElement('img');
                            img.src = "img/Star.png";
                            img.width = "20";
                            img.height = "18";
                            img.className = "lirating"
                            document.getElementById("staroutput").appendChild(img);
    ...
    saveData: function (ev) {
        ...
        xhr.addEventListener("load", function (ev) {
            ...
            if (response.code == 0) {
                ...
                console.log("Not Added, we got a problem bud.");
            }
        });
        xhr.addEventListener("error", function (ev) {
